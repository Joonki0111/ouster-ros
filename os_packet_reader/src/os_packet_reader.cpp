...
OSPacketReader::OSPacketReader() : Node("os_packet_reader_node")
{
    ...
    lidar_packet_pub_ = create_publisher<ouster_sensor_msgs::msg::PacketMsg>("/sensing/lidar/ouster/lidar_packets", rclcpp::QoS(1));
    metadata_pub_ = create_publisher<std_msgs::msg::String>("/sensing/ouster/metadata", metadata_qos);
